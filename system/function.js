...
exports.loadModule = async (connect, mydb = ["120363390114292114"]) => {
let array = mydb
...
exports.ucapan = () => {
  ...
  if (currentHour >= 5 && currentHour < 12) {
    greeting = 'صبح بخیر بھائی 🌅';
  } else if (currentHour >= 12 && currentHour < 15) {
    greeting = 'دوپہر بخیر بھائی 🌇';
  } else if (currentHour >= 15 && currentHour < 18) {
    greeting = 'شام بخیر بھائی 🌄';
  } else {
    greeting = 'رات بخیر بھائی 🌃';
  }
  return greeting;
}
